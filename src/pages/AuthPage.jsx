    ...
    <div className="auth-bg">
      ...
      <div className="auth-form-area">
        ...
        <div className="flex flex-col gap-8" style={{ marginBottom: 20 }}>
          <button className="btn btn-google btn-full" onClick={handleGoogle} id="btn-google-auth" disabled={loading}>
        ...
        <div className="flex items-center gap-12" style={{ marginBottom: 20 }}>
          ...
          <span className="text-muted text-xs" style={{ fontWeight: 600 }}>or</span>
          <div className="divider" style={{ flex: 1, margin: 0 }} />
        </div>
        ...
        <form onSubmit={handleEmailAuth}>
          {mode === 'signup' && (
            <div className="input-group">
              <label className="input-label" htmlFor="input-username">Username</label>
              <input id="input-username" className="input" type="text" placeholder="e.g. TacticMaster99" value={username} onChange={e => setUsername(e.target.value)} required />
            </div>
          )}
          <div className="input-group">
          ...
          <button type="submit" className="btn btn-primary btn-full" id="btn-email-auth" disabled={loading} style={{ marginBottom: 14 }}>
